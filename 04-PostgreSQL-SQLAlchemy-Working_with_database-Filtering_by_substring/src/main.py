...
tags_metadata = {
    ...
    "version": "ver. 0.3.1",  # По умолчанию version = "0.1.0", Source code in fastapi/applications.py
    "description": "77Тут должно быть подробное описание, но я размещу интересные для меня ссылки."
                   "<br><br>Полезные ссылки:  "
                   "<ul>"
                   "<li>описание метатегов (metadata) "
                   '<a href="https://fastapi.qubitpi.org/reference/fastapi/#fastapi.FastAPI--example" target="_blank">'
                   "сторонний сайт</a> или "
                   '<a href="https://fastapi.tiangolo.com/reference/fastapi/#fastapi.FastAPI--example" target="_blank">'
                   "документация FastAPI</a>.</li>"
                   "<li>Metadata and Docs URLs -> Metadata for API "
                   '<a href="https://fastapi.qubitpi.org/tutorial/metadata/#metadata-for-api" target="_blank">'
                   "сторонний сайт</a> или "
                   '<a href="https://fastapi.tiangolo.com/tutorial/metadata/#metadata-for-api" target="_blank">'
                   "документация FastAPI</a>.</li>"
                   '<li><a href="https://habr.com/ru/companies/amvera/articles/851642/" target="_blank">'
                   ...
                   '<li><a href="https://habr.com/ru/companies/amvera/articles/855740/" target="_blank">'
                   "Асинхронный SQLAlchemy 2: улучшение кода, методы обновления и удаления данных</a>.</li>"
                   '<li><a href="https://stackoverflow.com/questions/73248731/alembic-store-extra-information-in-alembic-version-table" target="_blank">'
                   ...
                   "</ul>"
                   'В методе API `delete("/hotels")` (удаление выбранных записей с выборкой, что '
                   "удалять, по наименованию и адресу отеля, функция: `delete_hotel_param_del`) "
                   "используется дополнительная возможность - получить список удаляемых записей "
                   "через параметр "
                   '<a href="https://docs.sqlalchemy.org/en/20/glossary.html#term-RETURNING" target="_blank">'
