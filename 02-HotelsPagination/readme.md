...
- Папка "[schemas](https://github.com/shilyas-ru/FastAPI_AS/tree/main/02-HotelsPagination/schemas)". Содержит схему данных, созданную с использованием Pydantic.
...
**Подробнее** в файле "[hotels_schemas.py](https://github.com/shilyas-ru/FastAPI_AS/blob/main/02-HotelsPagination/Routers_FastAPI/hotels_schemas.py)" или в файле "[hotels_full_file.py](https://github.com/shilyas-ru/FastAPI_AS/blob/main/02-HotelsPagination/Routers_FastAPI/hotels_full_file.py)".
